...
from src.gnue.common.external.plex.Transitions import TransitionMap
from src.gnue.common.external.plex import Machines
...
class StateMap:
	...
	def dump(self, file):
		from src.gnue.common.external.plex.Transitions import state_set_str
