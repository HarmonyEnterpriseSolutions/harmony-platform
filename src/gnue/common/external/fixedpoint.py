...
class FixedPoint(object):
	...
	def __mul__(self, other):
		...
		return _mkFP(self._roundquotient(n1 * n2, _tento(p)), p, self.__class__)
	...
	def __div__(self, other):
		...
		return _mkFP(self._roundquotient(n1 * _tento(p), n2), p, self.__class__)
...
#
import warnings
warnings.warn('FixedPoint is deprecated; use decimal.Decimal instead',DeprecationWarning, stacklevel=2)
