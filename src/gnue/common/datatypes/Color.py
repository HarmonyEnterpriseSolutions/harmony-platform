...
class Color:
	def __init__(self, value):
		...
		# HTML-style hash value
			...
			self.__red   = int(value[1:3], 16)
			self.__green = int(value[3:5], 16)
			self.__blue  = int(value[5:7], 16)
	...
	def toHex(self):
		if self.transparent:
			...
			return "#%s" % ('00000' + hex(int(self.__red*65536 + self.__green*256 + self.__blue))[2:])[-6:]
	...
	def __json__(self):
		...
		"""
		return self.__blue | self.__green << 8 | self.__red << 16 | (0 if self.transparent else 255) << 24
