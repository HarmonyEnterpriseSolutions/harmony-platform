...
from src.gnue.forms.uidrivers.java.widgets._remote import VBox


class UIVBox(UIWidget):

	def _create_widget_(self, event):
		self.widget = VBox(self, self._gfObject.label or "", self._gfObject.hasTitledBorder())
