...
for i in VK_TEXT.split('\n'):
	key, value = i.rstrip().split(' ')
	VK[key] = int(value)

from gnue.forms.input.GFKeyMapper import KeyMapper, vk

KeyMapper.setUIKeyMap({
	vk.C         : VK['VK_C'],
	vk.V         : VK['VK_V'],
	vk.X         : VK['VK_X'],
	vk.A         : VK['VK_A'],
	...
	vk.F11       : VK['VK_F11'],       
	vk.F12       : VK['VK_F12'],
	vk.INSERT    : VK['VK_INSERT'],  
	vk.DELETE    : VK['VK_DELETE'],
	vk.HOME      : VK['VK_HOME'], 
	vk.END       : VK['VK_END'],
	vk.PAGEUP    : VK['VK_PAGE_UP'],     
	vk.PAGEDOWN  : VK['VK_PAGE_DOWN'],
	vk.UP        : VK['VK_UP'],        
	vk.DOWN      : VK['VK_DOWN'],
	vk.LEFT      : VK['VK_LEFT'],      
	vk.RIGHT     : VK['VK_RIGHT'],
	vk.TAB       : VK['VK_TAB'],
	vk.ENTER     : VK['VK_ENTER'],
	vk.ESC       : VK['VK_ESCAPE'],
	vk.BACKSPACE : VK['VK_BACK_SPACE'],
	#vk.RETURN    : VK['VK_ENTER'],
})
