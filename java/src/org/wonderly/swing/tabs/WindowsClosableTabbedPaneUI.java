...
class WindowsClosableTabbedPaneUI extends WindowsTabbedPaneUI implements ClosableTabbedPaneUI {
	Logger log = Logger.getLogger( getClass().getName() );
	CloseableTabbedPane mypane;
	ImageIcon ci;
	ImageIcon dci;

	public WindowsClosableTabbedPaneUI( CloseableTabbedPane ctp ) {
		mypane = ctp;
	}
